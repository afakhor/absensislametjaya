...
class _GajiPageState extends State<GajiPage> {
  ...
  final DateTime _bulan = DateTime.now();

  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      db.prosesHitungGajiMingguan();
    });
  }
        ...
        children: [
          Container(
            ...
            child: FutureBuilder<int>(
              ...
              builder: (c, s) => Text(
                "Total Gajian Rp ${fmt.format(s.data ?? 0)} - ${DateFormat('MMMM yyyy', 'id_ID').format(_bulan)}",
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            trailing: PopupMenuButton(
                              onSelected: (v) => db.tandaiBayar(g.id, v.toString()),
                              itemBuilder: (_) => [
                                const PopupMenuItem(value: 'BELUM', child: Text("🔴 Belum")),
                                const PopupMenuItem(value: 'MINGGU1', child: Text("🟡 1 Minggu")),
